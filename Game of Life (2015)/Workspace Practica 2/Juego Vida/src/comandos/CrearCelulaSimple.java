...
public class CrearCelulaSimple extends Comando {
	...
	int y;
	 ...
	 /**
     * Ejecuta el dicho método, el cual permite crear una celula simple en las posiciones x,y
     * @param mundo recibe el mundo para poder llamar al método
     */
	@Override
	public void ejecuta(Mundo mundo) {		
		mundo.crearCelulaSimple(x, y);
	}
	...
	public Comando parsea(String[] cadenaComando) {
		...
		if ((cadenaComando[0] != null) && (cadenaComando[0].equals("CREARCELULASIMPLE")) && (cadenaComando.length == 3)) {
	...
	public String textoAyuda() {
		...
		return  "CREARCELULASIMPLE x y: Crea una nueva celula en las coordenadas (x, y)" + System.getProperty("line.separator");
	}
}
